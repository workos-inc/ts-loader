...
function successLoader(loaderContext, contents, callback, instance) {
    ...
    if (referencedProject !== undefined) {
        ...
        const noEmit = !utils_1.fileMatchesPatterns(instance.loaderOptions.emitOnly, filePath);
        const { outputText, sourceMapText } = instance.loaderOptions.transpileOnly || noEmit
