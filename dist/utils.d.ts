 ...
 */
export declare function formatErrors(_diagnostics: ReadonlyArray<typescript.Diagnostic> | undefined, _loaderOptions: LoaderOptions, _colors: Chalk, _compiler: typeof typescript, _merge: {
    file?: string;
    module?: WebpackModule;
}, _context: string): WebpackError[];
...
export declare function fileMatchesPatterns(patterns: RegExp[], file: string): boolean;
